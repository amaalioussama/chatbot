...
<path clipRule="evenodd" d="M0.000183105 0.99939L67.1047 0.999566L259 1" stroke="#605959"/>
    ...
    <Image src={Partner1}    className=" flex justify-center w-40 h-40 " alt="" />
    <Image src={Partner2}   className=" flex justify-center w-40 h-40" alt=""  />
    <Image src={Partner3}  className=" flex justify-center w-40 h-40" alt="" />
    <Image src={Partner4}  className=" flex justify-center w-40 h-40" alt=""  />
    <Image src={Partner5}     className=" flex justify-center w-40 h-40" alt="" />
