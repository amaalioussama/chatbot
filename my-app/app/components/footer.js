...
const Footer = () => {
  return <div>
    ...
    <footer class="bg-gradient-to-t from-black via-black to-black">
        ...
        <Image src={Logo} className="w-40 h-30" alt="Logo" />
        <p class="text-gray-500 dark:text-gray-400 font-medium mt-3">
          ...
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  ...
                  <ul class="text-gray-500 dark:text-gray-400 font-medium">
                      <li class="mb-4">
                          <a href="" class="hover:underline">content</a>
                      </li>
                      <li>
              ...
              <div>
                  ...
                  <ul class="text-gray-500 dark:text-gray-400 font-medium">
                      <li class="mb-4">
                          <a href="#" class="hover:underline">fatimazahraelhadrachi@gmail.com</a>
                      </li>
                      <li>
                      <a href="#" class="hover:underline">amaaliousama771@gmail.com</a>
                      </li>
                  </ul>
              </div>
          </div>
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 unicat™. All Rights Reserved.
          </span>
